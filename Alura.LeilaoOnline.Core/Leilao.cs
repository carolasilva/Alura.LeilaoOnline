...
namespace Alura.LeilaoOnline.Core
{
    ...
    public class Leilao
    {
        ...
        public void TerminaPregao()
        {
            ...
            {
                throw new System.InvalidOperationException("Não é possível terminar o pregão sem que ele tenha começado. Para isso, utilize o método IniciePregao()");
            }

            Ganhador = this._avaliador.Avalia(this);
